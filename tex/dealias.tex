...
are implemented as Procedure~{\tt\ref{fftpadBackwards}} and
Function~{\tt\ref{fftpadForwards}}.
...
inverse of fft0padBackwards({\sf f},{\sf u}).}
...
\begin{function}[htbp]
  ...
  \Return f/(6c)\;
\caption{conv({\sf f},{\sf g}) uses Procedure~{\tt \ref{build}} to compute
...
immediate convolution of constant $x$ columns (i.e.\ while still possibly in
...
inverse of Procedure fft0bipadBackwards({\sf f},{\sf u}).}
...
by taking a complex-to-real $2m$ transform of % this 2m is confusing. ??
...
of implicitly dealiased convolutions makes this argument moot.
