...
\subsection{Implicitly dealiased centered hyperconvolution}
...
$k'=k+m$ and padding the input vector by one element $U_{-m}=0$,
\belc
...
\subsection{Implicitly dealiased centered Hermitian hyperconvolution}
