...
implicitly-padded convolutions of two-dimensional vectors (both
Hermitian and not) in section \ref{2d}, and Hermitian
three-dimensional vectors in section \ref{3d}.  In section
...
given for Hermitian and general data. Finally, we show how FFTs may be
taken of data in which a general fraction $p/q$ is non-zero.


% FIXME: add biconvolutions, general p/q case.
