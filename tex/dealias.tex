...
Taking the computational cost of complex-to-real and real-to-complex Fourier
transforms of size~$N$ to be asymptotic to $\half K N\log_2 N$, the
...
faster than in-place transforms (cf. \cite{fftwoutofplace}) since they
