...
Memory usage is critical in many applications of convolution sums for direct
numerical simulation, image processing, and signal processing.

In higher dimensions, the memory usage of our noncentered (centered)
convolution is asymptotically one-half (two-thirds) of the memory
requirements imposed by zero padding.
...
innermost convolution to an external padded buffer, but this extra data
