...
Procedure~{\tt\ref{fftpadBackwards}} and~{\tt\ref{fftpadForwards}}.
...
\eelc
The forwards transform is then given for $k=-m+1,\ldots,m-1$ by
\bel
...
and the factor $(-1)^\ell$ in \Eq{fft0tforwards} cancels.
...
% LocalWords:  unpadded th unnormalized jk kU kj cconv ffttpadForwards Comput
