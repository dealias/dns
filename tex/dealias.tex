...
% We should also implement a noncentered Hermitian convolution.
...
%=\ds\sum_{m=0}^{N/4-1}\zeta_m^{2\ell m} \hat u_{2m}+
%\zeta_N^{2\ell}\sum_{m=0}^{N/4-1}\zeta_m^{2\ell m} \hat u_{2m+1}.
\ee
...
%=\ds\sum_{m=0}^{N/4-1}\zeta_m^{2\ell m} \zeta_N^{2m}\hat u_{2m}
%+\zeta_N^{2\ell+1}\sum_{m=0}^{N/4-1}\zeta_m^{2\ell m} \zeta_N^{2m}\hat u_{2m+1}
\ee
