...
without the computational expense of conventional zero-padding or
...
important distinction that the additional work memory need not contiguous
with the data.  This decoupling of the data and work arrays affords
%(explicit amount?)
significant reductions in memory usage and bandwidth for higher-dimensional
convolutions. 
