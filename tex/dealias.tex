...
nonlinear Casimir invariant $\int \v\w^4\,d\vx$ in the vorticity formulation
of two-dimensional incompressible flow~\cite{Bowman10}. The basic
building blocks for this problem are again the centered Fourier transform
and the Hermitian convolution.
