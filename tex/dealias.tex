% Document error stuff 
% Implement autosymmetrization.
...
can be implemented to be competitive with an explicitly padded
...
a $1024\times 1024$ implicit complex convolution is $1.92$ times faster.
The gains appear to increase with transform size: a $8192\times 8192$
%TODO: update timings...
