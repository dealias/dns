...
For example, in section~\ref{hyperconv} we illustrate how the technique 
can be applied to compute a centered Hermitian biconvolution.
...
still in cache) outweighs these losses.
