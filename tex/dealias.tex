...
implicit padding, ignoring outer bit reversal, in-place subtransforms, 
...
returns an in-place implicitly dealiased convolution of
{\sf f} and {\sf g} of length $(2m_x-1)\times m_y$ using temporary matrices 
{\sf U} and {\sf V} of length $(m_x+1)\times m_y$ and temporary vectors
{\sf u} and {\sf v} of length $m_y$.
.}\label{conv2}
\end{function}
