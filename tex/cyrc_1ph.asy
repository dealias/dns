...
for(int i=0; i<5; ++i){
  ...
  p=shift(z)*g;
  filldraw(pic,p,datapen);
  label(pic,"$\{F_k\}$",center(p),labelpen);
  q1=top(p);
  ...
  p=shift(z)*g;
  filldraw(pic,p,datapen);
  label(pic,"$\{G_k\}$",center(p),labelpen);
  q2=top(p);
  ...
  label(pic,"$\{F_kG_k\}$",center(p),labelpen);
  q1=top(p);
  draw(pic,p1..q1,EndArrow);
  ...
  p=shift(z)*g;
  filldraw(pic,p,convpen);
  label(pic,"$\{F^\Delta_k G^\Delta_k\}$",center(p),labelpen);
  q3=top(p);
  draw(pic,p3..q3,EndArrow);
